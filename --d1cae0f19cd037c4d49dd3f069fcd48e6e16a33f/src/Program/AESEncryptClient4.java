...
//
//
//public class AESEncryptClient4 extends ProgClient4 {
//
...
//    State outputState;
//
//    public AESEncryptClient4(short[] msgIn,int NkIn) {
//        msg = msgIn;
...
//        AESEncryptCommon.Nk = AESEncryptCommon.ois4.readInt();
//        AESEncryptCommon.Nr = AESEncryptCommon.Nk + 6;
//
//        // AESEncryptCommon.initCircuits();
//
//        LookupTableReceiver.ois = AESEncryptCommon.ois4;
...
//            slbs[i] = Utils.readBigInteger(bytelength, AESEncryptCommon.ois4);
//        }
...
//
//
//        rcver4.execProtocol(m);//每个client都需要执行
//        clbs = rcver4.getData();
//        StopWatch.taskTimeStamp("receiving labels for self's inputs");
//        clbs_own = rcver4.getData();
